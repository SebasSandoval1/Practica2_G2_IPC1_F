...
public class AsignarProfesores {
    ...
    public static int idProfesor[] = new int[31];
    public static int idCurso[] = new int[31];
    public static String Lineasdocumento[];
    public static String Guardadofecha;
    public static int[][] datosporprofesor = new int[31][16];
        ...
        try{
            ...
            for (int j = 0; j < filas.length; j++) {
                ...
                if (j == 0) {
                    ...
                    idProfesor[i] = Integer.parseInt(filas[j]);
    ...
    public void DatosAsignados() {
        ...
        for (int i = 1; i < CargaProfesores.Lineasdocumento.length; i++) { //i=1
            int cont = 0;
            for (int j = 1; j < Lineasdocumento.length; j++) { //j=2
                if (CargaProfesores.id[i] == idProfesor[j]) {
                    // idAlumnoIdentificado[i] = idAlumno[j];
                    datosporprofesor[i][cont] = idCurso[j];
                    cont++;
        ...
        for (int i = 1; i < Lineasdocumento.length; i++) {
            for (int j = 0; j < Lineasdocumento.length; j++) {
                ...
                System.out.print("" + datosporprofesor[i][j]);
            }
            System.out.println("");
        }
